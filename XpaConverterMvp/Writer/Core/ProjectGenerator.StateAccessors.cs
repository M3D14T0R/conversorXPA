...
internal static partial class ProjectGenerator
{
    ...
    private static ProjectGenerationState CreateParallelWorkerState(ProjectGenerationState source)
    {
        ...
        {
            ApplicationSelectMap = new Dictionary<string, string>(source.ApplicationSelectMap, StringComparer.OrdinalIgnoreCase),
            ParentSelectMapByTaskOrdinal = source.ParentSelectMapByTaskOrdinal.ToDictionary(
                kv => kv.Key,
                kv => new Dictionary<string, string>(kv.Value, StringComparer.OrdinalIgnoreCase)),
            DataSourceTypeByObjectOrdinal = new Dictionary<int, string>(source.DataSourceTypeByObjectOrdinal),
            DataObjectsByOrdinal = new Dictionary<int, DataObjectDef>(source.DataObjectsByOrdinal),
            AllFieldModels = source.AllFieldModels,
            AllTasks = source.AllTasks,
            TasksByOrdinal = new Dictionary<int, TaskSemantic>(source.TasksByOrdinal),
            ...
            ComponentNamespaces = new Dictionary<string, string>(source.ComponentNamespaces, StringComparer.OrdinalIgnoreCase),
            ComponentRightLiteralMap = new Dictionary<string, string>(source.ComponentRightLiteralMap, StringComparer.OrdinalIgnoreCase),
            ExternalMagicComponentNames = new HashSet<string>(source.ExternalMagicComponentNames, StringComparer.OrdinalIgnoreCase),
            ProjectReferenceMap = new Dictionary<string, string>(source.ProjectReferenceMap, StringComparer.OrdinalIgnoreCase),
            ...
            ComponentFunctionSourceByName = new Dictionary<string, string>(source.ComponentFunctionSourceByName, StringComparer.OrdinalIgnoreCase),
            ComponentFunctionReturnTypeByName = new Dictionary<string, string>(source.ComponentFunctionReturnTypeByName, StringComparer.OrdinalIgnoreCase)
        };
    }
